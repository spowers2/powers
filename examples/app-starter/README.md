# designlab206 — real-world Power UI example
...
- **No Lab/System chrome** — just an app built with `@power-ui/*`

## Stack

- `@power-ui/core` — signals, computed, effect  
- `@power-ui/dom` — JSX  
- `@power-ui/router` — routes  
