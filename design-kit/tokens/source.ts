...
const instrumentLightSemantic: FlatToken[] = [
  ...
  t(["color", "text", "muted"], "#5a6578", "color"),
...
const instrumentDarkSemantic: FlatToken[] = [
  ...
  t(["color", "border"], "rgba(154, 168, 188, 0.12)", "color"),
  t(["color", "border", "strong"], "#4a6a78", "color"),
  t(["color", "text"], "#e6edf7", "color"),
  t(["color", "text", "muted"], "#8b97ab", "color"),
  t(["color", "accent"], "#3d7ab8", "color"),
  t(["color", "accent", "hover"], "#5a93cc", "color"),
  t(["color", "accent", "fg"], "#050a12", "color"),
  t(["color", "signal"], "#69be28", "color"),
  t(["color", "success"], "#4f9a1c", "color"),
  ...
  t(["color", "soft", "bg"], "#1a2a18", "color"),
  t(["color", "soft", "bgHover"], "#223520", "color"),
  t(["color", "soft", "fg"], "#a8d48a", "color"),
  t(["color", "soft", "border"], "#3a4f38", "color"),
...
const dualLightSemantic: FlatToken[] = [
  ...
  t(["color", "text", "muted"], "#4a5d72", "color"),
  ...
  t(["color", "soft", "fg"], "#0e7490", "color"),
  t(["color", "soft", "border"], "#7ec8d9", "color"),
...
const dualDarkSemantic: FlatToken[] = [
  ...
  t(["color", "border"], "rgba(148, 163, 184, 0.11)", "color"),
  t(["color", "border", "strong"], "#2a7a8a", "color"),
  t(["color", "text"], "#e8eef8", "color"),
  t(["color", "text", "muted"], "#8b9bb0", "color"),
  t(["color", "accent"], "#38bdf8", "color"),
  t(["color", "accent", "hover"], "#7dd3fc", "color"),
  t(["color", "accent", "fg"], "#04080f", "color"),
  t(["color", "signal"], "#69be28", "color"),
  ...
  t(["color", "soft", "fg"], "#67e8f9", "color"),
  t(["color", "soft", "border"], "rgba(34, 211, 238, 0.35)", "color"),
