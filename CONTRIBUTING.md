...
- **Using Powers in an app:** `pnpm create powers my-app` or install `@lab206/*@0.1.9+` — see [`docs/NPM.md`](./docs/NPM.md).  
...
- Break the “one install just works” story (`create powers` / `@lab206/*@0.1.9+` / `powers()` Vite plugin) without an escape hatch  
