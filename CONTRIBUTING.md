...
- **Using Powers in an app:** `pnpm create powers my-app` or install `@lab206/*@0.1.4+` — see [`docs/NPM.md`](./docs/NPM.md).  
...
- Break the “one install just works” story (`create powers` / `@lab206/*@0.1.4+`) without an escape hatch  
